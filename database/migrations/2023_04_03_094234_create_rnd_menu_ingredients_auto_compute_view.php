...
class CreateRndMenuIngredientsAutoComputeView extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    {
        DB::statement("DROP VIEW IF EXISTS rnd_menu_ingredients_auto_compute;");
        DB::statement("DROP VIEW IF EXISTS rnd_menu_packagings_auto_compute;");
    }
}
