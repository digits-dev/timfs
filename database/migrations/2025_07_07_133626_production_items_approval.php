...
class ProductionItemsApproval extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('production_items_approvals', function (Blueprint $table) {
            $table->increments('id');
         ...
         Schema::table('production_items', function (Blueprint $table) {
           $table->integer('approved_by')->nullable()->after('final_value_vatinc');
    ...
    {
       Schema::dropIfExists('production_items_approvals');
