...
class CreateItemMastersFasApprovalsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('item_masters_fas_approvals', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('item_masters_fas_approvals');
    }
}
