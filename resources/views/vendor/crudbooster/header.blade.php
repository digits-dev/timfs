                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="user-footer">
                            <div class="pull-{{ cbLang('left') }}">
                                <a href="{{ route('AdminCmsUsersControllerGetProfile') }}" class="btn btn-default btn-flat" style="border-radius: 5px"><i
                                   class='fa fa-user text-info'></i> <small class="text-info">{{ cbLang("label_button_profile") }}</small></a>
                                <a href="{{ route('show-change-password') }}" class="btn btn-default btn-flat" style="border-radius: 5px"><i
                                   class='fa fa-key text-success'></i> <small class="text-success">Account</small> </a>
                            </div>
                            <div class="pull-{{ cbLang('right') }}">
                                <a title='Lock Screen' href="{{ route('getLockScreen') }}" class='btn btn-default btn-flat' style="border-radius: 5px"><i class='fa fa-lock text-warning'></i></a>
                                <a href="javascript:void(0)" onclick="swal({
                                        ...
                                        });" title="{{cbLang('button_logout')}}" class="btn btn-danger btn-flat" style="border-radius: 5px"><i class='fa fa-power-off'></i></a>
                            </div>
                        </li>
                    </ul>
                </li>
