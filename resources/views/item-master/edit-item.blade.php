                ...
                <div class="col-md-6">
                    <table class="table-responsive table">
                        <tbody>
                            ...
                            @endif
                            <tr>
                                <th><span class="required-star">{{ $action == 'edit' ? '*' : '' }}</span> Item Photo</th>
                                <td><input type="file" name="item_photo" id="item_photo" accept="image/*" class="form-control" max="2000000" {{ $action == 'edit' ? 'required' : '' }} ></td>
                            </tr>
                            <tr>
