...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        <form action="" id="form" class="form">
            ...
            <div class="row">
                <div class="col-md-2">
                    <button type="button" class="show-rnd-version btn btn-info" version-type="detail costing" rnd-menu-items-id="{{ $item->rnd_menu_items_id }}"><i class="fa fa-eye"></i> See Versions</button>
                </div>
                <div class="col-md-8">
    ...
    $(document).ready(function() {
        ...
        $('#approve-btn, #reject-btn').on('click', function() {
            ...
            if (noCodes > 0 && action == 'approve') {
                Swal.fire({
                    ...
                    html: `🔴 Please make sure all items used for this menu have item codes.` +
                        `<br/>📝 Wait until all items are created by <label class="label label-info">PURCHASING</label> in IMFS.` +
                        `<br/>🙏Thank you.`,
                    icon: 'warning',
                    width: '600px',
                });
            ...
            Swal.fire({
                ...
                html: (action == 'approve' 
                    ? `🟢 Doing so will push this item to <label class="label label-success">APPROVED ITEMS</label>.`
