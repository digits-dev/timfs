                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input value="{{$item->menu_item_description}}" type="text" class="form-control menu_description" placeholder="RND Temporary Menu Description" readonly>
                        </div>
                    </div>
                </div>
                <div class="col-md-2">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input value="{{$item->menu_price_dine}}" type="number" class="form-control menu_srp" placeholder="0.00" readonly>
                        </div>
                    </div>
                </div>
                <div class="col-md-2">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input value="{{$item->tasteless_menu_code}}" type="text" class="form-control tasteless_menu_code" placeholder="RND-XXXXX" readonly>
                        </div>
                    </div>
                </div>
                <div class="col-md-2">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input value="{{(float) $food_cost_data->portion_size}}" type="text" class="form-control portion_size" placeholder="RND-XXXXX" readonly>
                        </div>
                    </div>
                </div>
                <div class="col-md-2">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input value="{{(float) $food_cost_data->computed_food_cost}}" type="text" class="form-control food_cost" placeholder="RND-XXXXX" readonly>
                        </div>
                    </div>
                </div>
            </div>
    ...
    $(document).ready(function() {
        ...
        $.fn.submitForm = function(buttonClicked) {
            ...
            const form = $(document.createElement('form'))
                .attr('method', 'POST')
                .attr('action', "{{ route('menu_item_submit_packaging') }}")
                .hide();
            ...
            form.append(csrf, menuItemsId, packagings);
