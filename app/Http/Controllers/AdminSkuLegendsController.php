<?php namespace App\Http\Controllers;
	...
	class AdminSkuLegendsController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col = [];
			$this->col[] = ["label"=>"Sku Legend","name"=>"sku_legend"];
			...
			$this->form = [];
			$this->form[] = ['label'=>'Sku Legend','name'=>'sku_legend','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-4'];
			...
			# OLD START FORM
			//$this->form = [];
			//$this->form[] = ["label"=>"Sku Legend","name"=>"sku_legend","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
	        ...
	        */
	        $this->load_js = array();
	        $this->load_js[] = asset("js/sku_legend.js");
