<?php namespace App\Http\Controllers;
	...
	class AdminMenuSubcategoriesController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->title_field = "id";
			$this->limit = "20";
			$this->orderby = "subcategory_description,asc";
			...
			# OLD START FORM
			//$this->form = [];
			//$this->form[] = ["label"=>"Categories Id","name"=>"categories_id","type"=>"select2","required"=>TRUE,"validation"=>"required|integer|min:0","datatable"=>"categories,id"];
			//$this->form[] = ["label"=>"Subcategory Code","name"=>"subcategory_code","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
			//$this->form[] = ["label"=>"Subcategory Description","name"=>"subcategory_description","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
	        ...
	        */
	        $this->load_js = array();
	        $this->load_js[] = asset("js/menu_subcategory.js");
