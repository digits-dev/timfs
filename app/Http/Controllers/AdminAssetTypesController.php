<?php namespace App\Http\Controllers;
	...
	class AdminAssetTypesController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col = []; 
			$this->col[] = ["label"=>"Asset Types","name"=>"asset_type_description"];
			...
			$this->form = [];
			 	$this->form[] = [
					...
					'type' => 'text',
					'validation' => 'required|unique:asset_types,asset_type_description|min:3|max:30',
					'width' => 'col-sm-4'
				];
	        ...
	        */
	        $this->load_js = array();
	        $this->load_js[] = asset("js/asset_type.js");
